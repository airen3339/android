...
public class CompletetdAdpater extends RecyclerView.Adapter<CompletetdAdpater.ViewHolder>{
    private List<OrderBean> orderList;
    public CompletetdAdpater(List<OrderBean> list) {
        this.orderList = list;
    }
